...
# Program used to plot the limited capacity study generator power output data
...
f_baseline = 'power-gen 15MW 2.5s.mat'
f_limited5 = 'power-gen 25MW.mat'
f_limited10 = 'power-gen 20MW.mat'
f_unlimited = 'power-gen 15MW 2.5s.mat'
...
plt.title('Generator Power Output', pad=20)
plt.xlabel('Time, s')
plt.ylabel('Power, MW')
plt.xlim([0, 35])
...
if baseline:
  plt.ylim([48, 75])
  plt.savefig(f'plots/v2-plots/9-limited-capacity-power-gen-with-baseline.jpg', dpi=400, bbox_inches='tight')
else:
  plt.ylim([48, 64])
  plt.savefig(f'plots/v2-plots/9-limited-capacity-power-gen-no-baseline.jpg', dpi=400, bbox_inches='tight')
