...
grid = ['vGrid.mat', 'iGrid.mat']


time = [4, 6]

# Plotting q current
ds = f.importData(iqFiles, 'data/v2-data/0-vsc-results')
...
plt.plot(ds[iqFiles[1]]['Time'], ds[iqFiles[1]]['Value'],
         color='#F10A0A', linewidth=0.8, label='q Current Reference', linestyle='--')
...
# Plotting d current
ds = f.importData(idFiles, 'data/v2-data/0-vsc-results')
...
plt.plot(ds[idFiles[1]]['Time'], ds[idFiles[1]]['Value'],
         color='#F10A0A', linewidth=0.8, label='d Current Reference', linestyle='--')
...
# Plotting q voltage
ds = f.importData(vqFiles, 'data/v2-data/0-vsc-results')

plt.figure(figsize=(6, 4), dpi=400)

plt.plot(ds[vqFiles[0]]['Time'], ds[vqFiles[0]]['Value'],
         color='#0789FA', linewidth=1.4, label='q Voltage')

plt.grid(linewidth=0.3, linestyle='--', color='#E1E1E1')
plt.title('VSC Results - q Voltage', pad=20)
plt.xlabel('Time, s')
plt.ylabel('Voltage, V')
plt.xlim(time)
plt.ylim([-100, 1000])
plt.legend(loc='lower right')
plt.savefig('plots/v2-plots/0-vsc-vq.jpg', dpi=400, bbox_inches='tight')

# Plotting d voltage
ds = f.importData(vdFiles, 'data/v2-data/0-vsc-results')

plt.figure(figsize=(6, 4), dpi=400)

plt.plot(ds[vdFiles[0]]['Time'], ds[vdFiles[0]]['Value'],
         color='#0789FA', linewidth=1.4, label='d Voltage')

plt.grid(linewidth=0.3, linestyle='--', color='#E1E1E1')
plt.title('VSC Results - d Voltage', pad=20)
plt.xlabel('Time, s')
plt.ylabel('Voltage, V')
plt.xlim(time)
plt.ylim([-100, 20000])
plt.legend(loc='lower right')
plt.savefig('plots/v2-plots/0-vsc-vd.jpg', dpi=400, bbox_inches='tight')

# Plotting power
ds = f.importData(vscPowerFiles, 'data/v2-data/0-vsc-results')
...
plt.plot(ds[vscPowerFiles[1]]['Time'], ds[vscPowerFiles[1]]['Value'],
         color='#F10A0A', linewidth=0.8, label='VSC Power Reference', linestyle='--')
...
ds = f.import3phData(vsc, 'data/v2-data/0-vsc-results')
...
# Plotting Grid Voltage
ds = f.import3phData(grid, 'data/v2-data/0-vsc-results')

plt.figure(figsize=(6, 4), dpi=400)

plt.plot(ds[grid[0]]['Time'], ds[grid[0]]['a'],
         color=phase_colors[0], linewidth=1.4)
plt.plot(ds[grid[0]]['Time'], ds[grid[0]]['b'],
         color=phase_colors[1], linewidth=1.4)
plt.plot(ds[grid[0]]['Time'], ds[grid[0]]['c'],
         color=phase_colors[2], linewidth=1.4)

plt.grid(linewidth=0.3, linestyle='--', color='#E1E1E1')
plt.title('Grid Results - Voltage', pad=20)
plt.xlabel('Time, s')
plt.ylabel('Voltage, V')
plt.xlim(phase_time)
#plt.ylim([-100, 100])
plt.savefig('plots/v2-plots/0-grid-voltage.jpg', dpi=400, bbox_inches='tight')

# Plotting Grid Current
ds = f.import3phData(grid, 'data/v2-data/0-vsc-results')

plt.figure(figsize=(6, 4), dpi=400)

plt.plot(ds[grid[1]]['Time'], ds[grid[1]]['a'],
         color=phase_colors[0], linewidth=1.4)
plt.plot(ds[grid[1]]['Time'], ds[grid[1]]['b'],
         color=phase_colors[1], linewidth=1.4)
plt.plot(ds[grid[1]]['Time'], ds[grid[1]]['c'],
         color=phase_colors[2], linewidth=1.4)

plt.grid(linewidth=0.3, linestyle='--', color='#E1E1E1')
plt.title('Grid Results - Current', pad=20)
plt.xlabel('Time, s')
plt.ylabel('Current, A')
plt.xlim(phase_time)
plt.ylim([-400, 400])
plt.savefig('plots/v2-plots/0-grid-current.jpg', dpi=400, bbox_inches='tight')
