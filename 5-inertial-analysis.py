...
# Program used to carry out the inertial study analysis
...
for h in inertia:
    ...
    dsF = f.importData(filesF, 'data/v2-data/5-inertial-study')
    dsF_base = f.importData(filesF, 'data/v2-data/2-baseline-study')
    dsR = f.importData(filesR, 'data/v2-data/5-inertial-study')
    dsR_base = f.importData(filesR, 'data/v2-data/2-baseline-study')
    dsV = f.importData(filesV, 'data/v2-data/5-inertial-study')
