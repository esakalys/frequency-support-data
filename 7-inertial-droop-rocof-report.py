...
# Program used to plot the inertial = droop study rocof data
...
for h in inertia:
    for scenario in scenarios:
        ...
        plt.savefig(f'plots/v2-plots/7-report-inertial-droop-rocof-{h}-{scenario}.jpg', dpi=400, bbox_inches='tight')
