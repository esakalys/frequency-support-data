...
# Program used to plot the inertial + droop study generator power output data
...
for h in inertia:
    for scenario in scenarios:
        ...
        plt.savefig(f'plots/v2-plots/7-report-inertial-droop-power-gen-{h}-{scenario}.jpg', dpi=400, bbox_inches='tight')
