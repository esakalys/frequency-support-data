...
# Program used to plot the inertial study frequency data
...
for h in inertia:
    for scenario in scenarios:
        ...
        plt.savefig(f'plots/v2-plots/5-report-inertial-frequency-{h}-{scenario}.jpg', dpi=400, bbox_inches='tight')
